...
#line 113 "parser.y"
{ Value p; Object::InitWithNames(p, yymsp[-4].minor.yy122->values(), yymsp[-4].minor.yy122->names(true)); yygotominor.yy0 = CreateCall(List::c(yymsp[-8].minor.yy0, p, yymsp[0].minor.yy0, Character::c(parser->popSource())));   yy_destructor(yypParser,36,&yymsp[-6].minor);
...
#line 126 "parser.y"
{ if(yymsp[0].minor.yy0.isSymbol()) yymsp[0].minor.yy0 = Character::c(Symbol(yymsp[0].minor.yy0)); yygotominor.yy0 = CreateCall(List::c(yymsp[-2].minor.yy0, yymsp[-3].minor.yy0, yymsp[0].minor.yy0)); }
#line 1153 "parser.c"
        break;
      case 51: /* expr ::= NEXT */
