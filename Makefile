...
SRC := main.cpp type.cpp strings.cpp bc.cpp value.cpp output.cpp interpreter.cpp compiler.cpp internal.cpp parser.cpp coerce.cpp library.cpp runtime.cpp jit.cpp jit_opt.cpp jit_reg.cpp jit_guards.cpp jit_forward.cpp jit_compile.cpp
